...
During the first week of the work on this project we discussed all features and metrics and agreed on the following clarifications and changes to the [initial task statement](https://github.com/BugaevGleb/InnoScream/blob/main/ProjectDescription.pdf):
...
- **Bot response time:**  
  ...
  *Our result:* ([See Locust Results](https://bugaevgleb.github.io/InnoScream/locust_result.html))   
...
[Here you can see a presentation of this project](https://github.com/BugaevGleb/InnoScream/blob/main/InnoScream.pdf)
